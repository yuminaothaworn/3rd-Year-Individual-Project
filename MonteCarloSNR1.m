...
sigma_db = linspace(-10,100,nbrPoints);
%sigma_db = inf;
...
for i=1:nbrPoints
    ...
    for j=1:monteCarloRun
        ...
        sigma = 1 / (u*SNR_linear(i)); %signal power = 1
    ...
    %save("MonteCarloResultsSNR5test_4_1.mat","coverageProbability","sigma_db")
end

%plot results
x=sigma_db; %row of matrix
...
save("MonteCarloResultsSNR5_1_1.mat","coverageProbability","sigma_db")